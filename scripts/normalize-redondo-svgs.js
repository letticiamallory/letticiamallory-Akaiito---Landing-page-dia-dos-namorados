/**
 * Normaliza Default + mordidas do Redondo para canvas 25×25 (mesmo tamanho).
 *
 * Default/Variant3: export 32×32; Variant4/Variant6: export 25×25 — todos escala 25/32
 *
 *   node scripts/import-redondo-figma.js "<pasta-figma>"
 *   node scripts/normalize-redondo-svgs.js
 */
const fs = require("fs");
const path = require("path");

const DIR = "public/chocolate/chocolates/redondo";
const THUMB = "public/chocolate/chocolates/redondo.svg";
const OUT = 25;
...
console.log(`Redondo SVGs → viewBox="${vb}", scale ${SCALE}`);
