/**
 * Normaliza Default + mordidas do Especial para canvas 25×25 (mesmo tamanho).
 *
 * Default: export 43×40 — recorte 28×28 centrado no coração + escala 25/28
 * Mordidas: export 28×28 — escala 25/28
 *
 *   node scripts/import-especial-figma.js "<pasta-figma>"
 *   node scripts/normalize-especial-svgs.js
 */
const fs = require("fs");
const path = require("path");

const DIR = "public/chocolate/chocolates/especial";
const THUMB = "public/chocolate/chocolates/especial.svg";
const OUT = 25;
...
console.log(
  `Especial SVGs → viewBox="${vb}", scale ${BITE_SCALE}, crop large @ (${CROP_X}, ${CROP_Y})`
);
