/**
 * Importa sequência do Coração (chocolate 2) a partir da pasta de export do Figma.
 *
 *   node scripts/import-coracao-figma.js "C:\...\Valentine's Day Box of Chocolates (Community) (5)"
 *
 * Ordem de clique após Default: Variant2 → Variant4 → Variant6
 */
const fs = require("fs");
...
if (!srcDir || !fs.existsSync(srcDir)) {
  console.error("Usage: node scripts/import-coracao-figma.js <figma-export-folder>");
  process.exit(1);
}

const OUT_CHOC = "public/chocolate/chocolates/coracao";
const OUT_THUMB = "public/chocolate/chocolates/coracao.svg";
...
console.log("Sidebar thumbnail: coracao.svg");
